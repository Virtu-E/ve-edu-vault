...
class TestFailedTagsCollector:
    ...
    def test_no_failed_questions(self, collector):
        ...
        questions = [QuestionAIContextFactory(tags=["python", "loops"], attempts=AttemptsFactory(success=True)), QuestionAIContextFactory(tags=["javascript", "arrays"], attempts=AttemptsFactory(success=True))]
    ...
    def test_all_questions_failed(self, collector):
        ...
        questions = [QuestionAIContextFactory(tags=["python", "loops"], attempts=AttemptsFactory(success=False)), QuestionAIContextFactory(tags=["javascript", "arrays"], attempts=AttemptsFactory(success=False))]
    ...
    def test_mixed_success_and_failure(self, collector):
        ...
        questions = [QuestionAIContextFactory(tags=["python", "loops"], attempts=AttemptsFactory(success=True)), QuestionAIContextFactory(tags=["javascript", "arrays"], attempts=AttemptsFactory(success=False))]
    ...
    def test_duplicate_tags_across_questions(self, collector):
        ...
        questions = [QuestionAIContextFactory(tags=["python", "algorithms"], attempts=AttemptsFactory(success=False)), QuestionAIContextFactory(tags=["algorithms", "data-structures"], attempts=AttemptsFactory(success=False))]
    ...
    def test_empty_tags_list(self, collector):
        ...
        questions = [QuestionAIContextFactory(tags=[], attempts=AttemptsFactory(success=False)), QuestionAIContextFactory(tags=["python"], attempts=AttemptsFactory(success=False))]
    ...
    def test_special_characters_in_tags(self, collector):
        ...
        questions = [QuestionAIContextFactory(tags=["c++", "object-oriented"], attempts=AttemptsFactory(success=False)), QuestionAIContextFactory(tags=["#python", "machine-learning"], attempts=AttemptsFactory(success=False))]
    ...
    def test_case_sensitivity(self, collector):
        ...
        questions = [QuestionAIContextFactory(tags=["Python", "python", "PYTHON"], attempts=AttemptsFactory(success=False))]
